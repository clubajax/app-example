    ...
    return dcl(null, {
        ...
        constructor: function(chart, engine, settings){
            ...
            function setLimits(newLimits, silent) {
                ...
                settings.limits = engine.indexedData.setLimits(newLimits);
                if (!silent) {
        ...
        getActualLimits: function () {
            return this.engine.indexedData.getActualLimits();
        },
