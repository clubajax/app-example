define([], function(){
    ...
    // This is a light-weight stub that can take the place of the larger knockout
    // In the chart this is used for simplicity, but it will be exckuded from the
    // build and full knockout used in its place.
    //
	...
	function observableFactory( _item ){
        ...
        observable.valueHasMutated = observable.publish;

		// for testing what this is.
	...
	return {
        ...
        isObservable:observableFactory.isObservable
    };
});
