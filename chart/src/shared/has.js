;(function(g){
    ...
    // Good place for new tests?
    // I personally would like all feature tests to be in one place
    // regardless of how messy this file may get. - mw
    has.add('touch', function(win, doc, div ){
        try {
