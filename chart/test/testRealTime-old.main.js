...
require([
    ...
    window.chart = new main.Chart($container, {
        ...
        xAxis: {
            ...
            onLimitsChanged: function (newLimits) {
                console.log('onLimitsChanged', newLimits);
                var
    ...
    window.chart.on(window.chart.limits, function(){
        console.log('emit limit');
    });
    ...
    window.scrollbar = new HorizontalScrollBar($container,{
        ...
        onEndRangeChangeCallback: function () {
            console.log('onEndRangeChangeCallback');
            isScrolling = false;
