    ...
    function (domReady, jquery) {
        ...
        domReady(function () {
            ...
            requirejs([
                ...
                function (Chart, seriePainterFactory, resourceMananger, Broker, userInteractionTypes, Selection, Datatip, utilities, Crosshair, HorizontalZoom, VerticalZoom, DrawingObjectEditor) {

                    var $container = $('#parent'),
                        broker = new Broker();

                    broker.pluginsStack.push(new Selection());
                    broker.pluginsStack.push(new DrawingObjectEditor({ $domElement: $container }));
                    ...
                    window.chart = new Chart($container, {
                        ...
                        { timeStamp: new Date(2012, 2, 31, 9, 37, 0, 0), values: [{ value: 13.16 }, { value: 13.26 }, { value: 13.07 }, { value: 13.13 }, { value: 115641585 }] }],
                                    ...
                                    {
                                        definesScaling: false,
                                        inputs: [{ name: 'point1', value: { timeStamp: new Date(2012, 2, 20, 9, 37, 0, 0), price: 12.50 } },
                                                 { name: 'point1', value: { timeStamp: new Date(2012, 2, 14, 9, 37, 0, 0), price: 14.50 } }],
                                        data: [],
                                        layers: [{
                                            isSelected: false,
                                            chartType: {
