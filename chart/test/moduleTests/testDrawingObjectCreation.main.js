...
require([
    ...
    function (domReady, Chart, seriePainterFactory, resourceMananger, Broker, userInteractionTypes, chartTypes, Selection, DrawingObjectEditor, HorizontalZoom, VerticalZoom, DrawingObjectCreator) {
                        ...
                        },
{
    ...
    chartType: {
        ...
        dataPointDefinitions: [{
            ...
            var limits = window.chart.xAxis().limits;
            limits({ minValueIndex: 0, maxValueIndex: 88 });
            limits({ minValueIndex: 4, maxValueIndex: 83 });
            //debugger;
            limits({ minValueIndex: 33, maxValueIndex: 48 });
        });
    });
