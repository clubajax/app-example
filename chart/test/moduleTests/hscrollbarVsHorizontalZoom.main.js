    ...
    function (domReady, jquery, ko) {
        ...
        domReady(function () {
            ...
            requirejs([
                ...
                function (Chart, seriePainterFactory, resourceMananger, Broker, userInteractionTypes, Selection, HorizontalScrollBar, Datatip, utilities, Crosshair, HorizontalZoom, VerticalZoom) {
                            ...
                            onLimitsChanged: function (newLimits) {
                                ...
                                if (totalRange) {
                                    if (actualLimits) {
                                        ...
                                        !window.scrollbar.isVisible() && window.scrollbar.isVisible(true);
                                    } else {
                    ...
                    window.chart.graphs([                            //#region subgraph 1
                            {
                                ...
                                axes: [{
                                    ...
                                    series: [{
                                        data: [{ timeStamp: new Date(2012, 0, 1, 9, 37, 0, 0), values: [{ value: 11.83 }, { value: 11.87 }, { value: 11.50 }, { value: 11.57 }, { value: 215071520 }] },
                                            ...
                                            { timeStamp: new Date(2012, 2, 27, 9, 37, 0, 0), values: [{ value: 13.63 }, { value: 13.72 }, { value: 13.45 }, { value: 113.48 }, { value: 87742979 }] },
                                            { timeStamp: new Date(2012, 2, 28, 9, 37, 0, 0), values: [{ value: 13.50 }, { value: 13.59 }, { value: 13.43 }, { value: 113.49 }, { value: 63352850 }] },
                                            { timeStamp: new Date(2012, 2, 29, 9, 37, 0, 0), values: [{ value: 13.40 }, { value: 13.58 }, { value: 13.31 }, { value: 113.47 }, { value: 100578453 }] },
                                            { timeStamp: new Date(2012, 2, 30, 9, 37, 0, 0), values: [{ value: 13.61 }, { value: 13.64 }, { value: 13.21 }, { value: 113.27 }, { value: 124675884 }] },
                                            { timeStamp: new Date(2012, 2, 31, 9, 37, 0, 0), values: [{ value: 13.16 }, { value: 13.26 }, { value: 13.07 }, { value: 113.13 }, { value: 115641585 }] }],
                                        limits: {
                                            time: {
                                                minValueIndex: 40,
                                                minValue: null,
