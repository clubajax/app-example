    ...
    function (domReady, jquery) {
        ...
        domReady(function () {
            ...
            requirejs([
                ...
                function (Chart, seriePainterFactory, resourceMananger, Broker, userInteractionTypes, utilities, Crosshair) {
                        ...
                        graphs: [
                            //#region subgraph 1
                            {
                                ...
                                axes: [{
                                    ...
                                    {
                                        data:
                                           [{ timeStamp: new Date(2012, 7, 7, 9, 37, 0, 0), values: [{ value: 11.75 }] },
                                            { timeStamp: new Date(2012, 7, 9, 9, 37, 0, 0), values: [{ value: 12.74 }] },
                                            { timeStamp: new Date(2012, 7, 11, 9, 37, 0, 0), values: [{ value: 10.61 }] },
                                            { timeStamp: new Date(2012, 7, 16, 9, 37, 0, 0), values: [{ value: 11.36 }] },
                                            { timeStamp: new Date(2012, 7, 18, 9, 37, 0, 0), values: [{ value: 11.26 }] },
                                            { timeStamp: new Date(2012, 7, 19, 9, 37, 0, 0), values: [{ value: 10.83 }] },
                                            { timeStamp: new Date(2012, 7, 20, 9, 37, 0, 0), values: [{ value: 9.79 }] },
                                            { timeStamp: new Date(2012, 7, 21, 9, 37, 0, 0), values: [{ value: 10.83 }] },
                                            { timeStamp: new Date(2012, 7, 22, 9, 37, 0, 0), values: [{ value: 13.61 }] },
                                            { timeStamp: new Date(2012, 7, 23, 9, 37, 0, 0), values: [{ value: 11.36 }] },
                                            { timeStamp: new Date(2012, 7, 24, 9, 37, 0, 0), values: [{ value: 12.26 }] },
                                            { timeStamp: new Date(2012, 7, 25, 9, 37, 0, 0), values: [{ value: 12.83 }] }],
                                        limits: {
                                            time: {
                                                minValueIndex: 40,
                                                minValue: null,
