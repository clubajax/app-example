...
],function ($, data, seriesData, Chart, resourceMananger, Broker, Selection, Crosshair, DrawingObjectEditor, HorizontalZoom, VerticalZoom) {


    var $container = $('#chart');

        new Chart({instanceId:'MIKE'}, $container);
