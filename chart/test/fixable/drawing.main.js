...
require([
        ...
        'test/data/timestamped',
        'test/data/series'
],function (main, $, data, seriesData, resourceMananger, Broker, userInteractionTypes, Selection, Crosshair, DrawingObjectEditor, HorizontalZoom, VerticalZoom, timestamped, series) {
